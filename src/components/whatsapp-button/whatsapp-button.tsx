  ...
  ({
    ...
    return (
      <a
        ...
        class="cta-floating group fixed bottom-6 left-6 z-50 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#25D366] shadow-xl shadow-emerald-500/25 transition-all duration-300 ease-out hover:scale-110 hover:rounded-xl hover:shadow-emerald-500/40 sm:h-16 sm:w-16"
      ...
      >
        <svg
          ...
          width="32"
          height="32"
          class="h-7 w-7 fill-white sm:h-8 sm:w-8 group-hover:rotate-6 transition-transform duration-300"
